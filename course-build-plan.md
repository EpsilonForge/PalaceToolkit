...
| 17 | fragment | Plot: dispersion diagram (β vs frequency) |
...
| 21 | fragment | Compare to analytic approximation: `ε_eff ≈ (ε_r + 1)/2 + (ε_r - 1)/2 * 1/√(1 + 12h/w)` |
...
**Design Brief:**
> *"Design and characterize a 2.45 GHz inset-fed microstrip patch antenna on FR4 (ε_r = 4.4, h = 1.6 mm, loss_tan = 0.02)."*
...
- [ ] 2D mode solver gives reasonable ε_eff
